...
Write-Host "[SUCCESS] JWT SECRET GENERATED:`n" -ForegroundColor Green
Write-Host "----------------------------------------------------------------" -ForegroundColor Gray
Write-Host "$jwtSecret" -ForegroundColor White
Write-Host "----------------------------------------------------------------" -ForegroundColor Gray

Write-Host "`n[INSTRUCTIONS] COPY THIS SECRET TO RENDER:" -ForegroundColor Cyan
...
Write-Host "   - Length: 64 characters (verified)" -ForegroundColor Green
Write-Host "   - Randomness: Cryptographically secure (verified)" -ForegroundColor Green
Write-Host "   - Never commit this to Git (important)" -ForegroundColor Green
Write-Host "   - Store only in Render Dashboard (important)" -ForegroundColor Green

Write-Host "`n[INFO] SECRET COPIED TO CLIPBOARD" -ForegroundColor Green
